...
class Patients extends Component {
  ...
  componentDidMount() {
    ...
    fetch("http://192.241.145.208:8890/lims/inventory/products", {
      method: "GET",
      headers: {
  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        dataIndex: "units",
        key: "units",
        ...this.getColumnSearchProps("units")
      },
      {
        title: "Measure",
        dataIndex: "measure",
            ...
            <Content style={{ background: "#fff" }}>
              <div style={{ background: "#fff", padding: "30px" }}>
                ...
                <PageHeader
                    ...
                    subTitle="Summary of products"
                    extra={[

                      <Button key="1" type="primary" onClick={() => this.props.history.push('/inventory/addproducts')}>
                        AddProduct
    </Button>
                    ]}
                  >
                ...
                <div className="dtable" style={{ background: "#fff" }}>
                  <Table columns={columns}   dataSource={this.state.bars} />
                </div>
              </div>
            </Content>
          </Spin>
