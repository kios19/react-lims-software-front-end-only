...
class Results extends Component {
  ...
  showConfirm =e => {
    confirm({
      title: 'Do you Want to submit test '+sessionStorage.getItem("sptestid")+'?',
      content: sessionStorage.getItem("vptestname") +' test for patient ' + sessionStorage.getItem("vppatientname"),
      onOk() {
        console.log('OK');
  ...
  handleSearch = e => {
    ...
    fetch("http://192.241.145.208:8890/lims/tests/getResult", {
      ...
      body: JSON.stringify({ testId: sessionStorage.getItem("sptestid") })
    })
      .then(res => res.json())
      .then(data => {
              ...
              <div style={{ background: "#fff", padding: "30px" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <button className="buttonu" onClick={this.showConfirm} >
